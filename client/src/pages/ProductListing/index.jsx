            ...
            <div className='bg-[#f1f1f1] p-2 w-full mb-4 rounded-md flex items-center justify-between'>
              ...
              <div className='col2 ml-auto flex items-center justify-end gap-3 pr-4'>
                ...
                >
                  ...
                  <MenuItem onClick={handleClose} className='text-[13px] !text-[#000] !capitalize'>Price, low to hight</MenuItem>
                  <MenuItem onClick={handleClose} className='text-[13px] !text-[#000] !capitalize'>Price, hight to low</MenuItem>
                </Menu>
              </div>
            </div>

            <div className={`${itemView === 'grid' ? 'grid grid-cols-4 md:grid-cols-4' : 'grid grid-cols-1 md:grid-cols-1'} gap-4`}>
              {
                itemView === 'grid' ?
                        <>
                          <ProductItem />
