...
const QtyBox = () => {
  ...
  const minusQty = () => {
    setQtyVal(qtyVal - 1 < 1 ? 1 : qtyVal - 1);
  }
  ...
  return (
    <div className='qtyBox flex items-center relative'>
      ...
      <div className='flex items-center flex-col justify-between h-[40px] absolute top-0 right-0 z-50 !border-l-2 border-[#rgba(0, 0, 0, 0.2)]'>
        <Button
