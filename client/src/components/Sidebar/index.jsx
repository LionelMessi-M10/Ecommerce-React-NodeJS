...
const Sidebar = () => {
  ...
  return (
    <aside className='sidebar py-5'>
      {/* Filter category */}
      <div className='box'>
        <h3 className='mb-3 text-[16px] font-[600] flex items-center justify-between pr-5'>
          Shop By Category
          <Button 
      ...
      <div className='box mt-4'>
        ...
        <div className='flex pt-4 pb-2'>
          <span className='text-[13px]'>
            From: <strong className='text-black'>0</strong>
          </span>
          <span className='ml-auto text-[13px]'>
            To: <strong className='text-black'>100000</strong>
          </span>
        </div>
      </div>
