  ...
  return (
    <>
      ...
      <p className='mt-3 pr-10'>
        Learn How To Create Full Stack Ecommerce Website Using React JS, MongoDB, Express JS and
        Node JS | React JS Project to Make Full Stack E-Commerce Website
      </p>
      ...
      <p className='text-[14px] mt-5 mb-2 text-[#000]'>
        Free Shipping (Est. Delivary Time 2-3 Days)
      </p>
